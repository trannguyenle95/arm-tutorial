...
namespace arm_controllers{
	...
	class test: public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
		public:
		~test() 
		{
		...
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
  		{	
			...
			command_sub_ = n.subscribe<std_msgs::Float64MultiArray>("command", 1, &test::commandCB, this);
...
PLUGINLIB_EXPORT_CLASS(arm_controllers::test, controller_interface::ControllerBase)
